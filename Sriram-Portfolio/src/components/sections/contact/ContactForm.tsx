...
const socialLinks = [
  {
    ...
    user: '@instagram',
    icon: FaInstagram,
    link: 'https://www.instagram.com/its.sriramhere?igsh=MTM0eTNnb3h6Z2t2dg%3D%3D&utm_source=qr',
  },
  {
    title: 'Youtube',
    user: '@youtube',
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-white/10 pt-5 mt-6">
        ...
        {/* LINKEDIN */} 
        <motion.a
          href="https://www.linkedin.com/in/sriram-sundaram-801b51410?utm_source=share_via&utm_content=profile&utm_medium=member_ios"  
          target="_blank"
